        ...
        <div style={{ backgroundColor:'#C8A799', height:'852px', width:'393px', backgroundImage:'url(../public/cake.png)', backgroundRepeat:'no-repeat', backgroundPosition:'center'}}>
            ...
            <div style={{backgroundColor:'#FADCCB', margin:'0px 30px', borderRadius:'17px', padding:'5px 20px', height:'500px'}}>
                ...
                <div style={{textAlign:'center', marginTop:'70px'}}>
                    <input type="text" placeholder="YYYY" required style={{background:'none', color:'#000000', border:'none', borderBottom:'1px solid #000000', outline:'none', margin:'15px 0', fontSize:'15px', paddingLeft:'10px'}} />
                    <input type="text" placeholder="MM" required style={{background:'none', color:'#000000', border:'none', borderBottom:'1px solid #000000', outline:'none', margin:'15px 0', fontSize:'15px', paddingLeft:'10px'}} />
                    <input type="text" placeholder="DD" required style={{background:'none', color:'#000000', border:'none', borderBottom:'1px solid #000000', outline:'none', margin:'15px 0', fontSize:'15px', paddingLeft:'10px'}} />
                </div>
            </div>
            <div style={{margin:'20px 30px'}}>
                <button onClick={() => navigate(-1)} style={{width:'100px', marginRight:'10px', background:'none', border:'1px solid #ffffff'}}>이전</button>
                <button style={{width:'220px', background:'#EF5B5B'}}>다음으로</button>
            </div>
        </div>
    );
}
